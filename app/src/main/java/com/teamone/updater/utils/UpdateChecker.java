 ...
 */
package com.teamone.updater.utils;
...
import com.teamone.updater.UpdaterApplication;
import com.teamone.updater.activities.UpdaterActivity;
import com.teamone.updater.misc.Constants;
import com.teamone.updater.misc.State;
import com.teamone.updater.misc.UpdateInfo;
import com.teamone.updater.requests.UpdatesJsonObjectRequest;
import com.teamone.updater.service.UpdateCheckService;
...
public class UpdateChecker implements Response.ErrorListener, Response.Listener<JSONObject> {
    ...
    // broadcast actions
    public static final String ACTION_CHECK_FINISHED = "com.teamone.updater.action.UPDATE_CHECK_FINISHED";
