 ...
 */
package com.teamone.updater.misc;

import android.app.AlarmManager;

public class Constants {
    // Download related
    public static final String UPDATES_FOLDER = "AOSP-Updates";
    public static final String DOWNLOAD_ID = "download_id";
    public static final String DOWNLOAD_NAME = "download_name";
    public static final String DOWNLOAD_TMP_EXT = ".tmp";
    public static final String DOWNLOAD_CHANNEL_ID = "com.teamone.updater.DOWNLOAD_CHANNEL";
    public static final String DOWNLOADING_CHANNEL_ID = "com.teamone.updater.DOWNLOADING_CHANNEL";
    // Preferences
    ...
    // Build vars
    public static final String CURRENT_DEVICE_NAME = "com.teamone.device";
    public static final String CURRENT_VERSION = "com.teamone.version";
    public static final String OTA_URL = "https://raw.githubusercontent.com/AOSP-CAF-MSM8916/OTA/8.1/{device}.json";
    public static final String OTA_VERSION_CODE = "com.teamone.updater.version_code";
    // Expressions
